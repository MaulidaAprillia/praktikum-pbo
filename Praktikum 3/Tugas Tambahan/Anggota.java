...
//NIM       : 24060122120029
//Deskripsi : Program representasi Anggota dan penggunaan eksepsi
...
public class Anggota {
    ...
    // tidak tersedia dipinjam dengan throw keyword
        if(jumlahBukuPinjaman >=3 ){
            throw new MaksimumBukuTerpinjamException("Jumlah maksimum buku yang dipinjam telah tercapai");
        }
